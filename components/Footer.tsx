      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-6">
        <div className="space-y-3">
          <div className="flex items-center justify-center gap-2 flex-wrap">
            ...
            <a 
              href="https://instagram.com/oneis2one" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-pink-500/10 text-pink-500 hover:bg-pink-500/20 transition-colors border border-pink-500/20"
              aria-label="Instagram profile @oneis2one"
            >
              ...
              <span className="font-semibold text-xs tracking-wide">@oneis2one</span>
            </a>
          </div>
          <p className="text-xs tracking-wider uppercase opacity-75">
            Engineered & Maintained by <span className="font-semibold text-[var(--text)]">Deepesh</span>
          </p>
        </div>
